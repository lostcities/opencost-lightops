...
const (
	...
	EuroToUSDExchangeRate = "EURO_TO_USD_EXCHANGE_RATE"
)
...
// GetEuroToUSDExchangeRate returns the environment variable value for EuroToUSDExchangeRate which
// provides the current Euro to USD exchange rate.
func GetEuroToUSDExchangeRate() string {
	return Get(EuroToUSDExchangeRate, "1.6")
}
